<template>
  <el-container>
    ...
    <el-main>
      ...
      <el-row :gutter="20">
        <el-col :span="18">
          <el-row v-for="o in 4" :key="o" style="margin-top: 30px">
            <el-col :span="24">
              <el-card class="box-card" :body-style="{ padding: '0px' }">
                <div class="article-title-card">
                  <span>这里是文章标题-这里是文章标题-这里是文章标题-</span>
                  <div class="tag-info">
                    <span>标签1</span>
                    <span>标签2</span>
                    <span>标签3</span>
                ...
                <div class="article-content-card">
                  <p>这里是文章内容-这里是文章内容-这里是文章内容-这里是文章内容-这里是文章内容-这里是文章内容-这里是文章内容-这里是文章内容-这里是文章内容-这里是文章内容-这里是文章内容-这里是文章内容-这里是文章内容-这里是文章内容-这里是文章内容-这里是文章内容-这里是文章内容-这里是文章内容-这里是文章内容-这里是文章内容-这里是文章内容-这里是文章内容-这里是文章内容-这里是文章内容-这里是文章内容-</p>
                  <div class="remark">
                    <span><svg-icon style="margin-right:5px;" icon-class="icon_calendar_fill" />2019年8月4日 12:12:34</span>
                    <span><svg-icon style="margin:0 5px;" icon-class="eye-open" />123</span>
                    <span><svg-icon style="margin:0 5px;" icon-class="icon_message_fill" />3</span>
                  </div>
                </div>
              </el-card>
            </el-col>
